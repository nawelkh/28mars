...
export default function About() {
  ...
  const userData = useSelector((state) => state.userReducer.credentials);
    ...
    return (
      ...
      <span  className={classes.titre}>Université :</span>           <span className={classes.info}>UMMTO</span> <br/>
      <span className={classes.titre}>Faculté :</span>           <span className={classes.info}>génie éléctrique et informatique</span> <br/>
      <span className={classes.titre}>Département :</span>           <span className={classes.info}>informatique</span> <br/>
